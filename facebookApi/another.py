...
def fb_login():
	...
	emailelement = browser.find_element_by_name(email_tag)
	passwordelement = browser.find_element_by_name(password_tag)
	emailelement.send_keys(user_id)
	passwordelement.send_keys(user_pass)
	loginelement = browser.find_element_by_id(login_btn)
	loginelement.click()
